function (setup_coverage_report_target)
  if (ENABLE_COVERAGE_REPORT)
      ...
      elseif(${CMAKE_CXX_COMPILER_ID} STREQUAL "Clang")
        ...
        add_custom_target(
          generate-coverage-report
          COMMAND ${LLVM_PROFDATA} merge ${CMAKE_BINARY_DIR}/coverage/*.profraw --output ${CMAKE_BINARY_DIR}/coverage.profdata 
          COMMAND ${LLVM_COV} show ${OBJECTS} -instr-profile=${CMAKE_BINARY_DIR}/coverage.profdata -format=text > coverage.info
          )
      endif()
...
function(setup_coverage_report_flags TARGET)
  if (ENABLE_COVERAGE_REPORT)
    ...
    elseif(${CMAKE_CXX_COMPILER_ID} STREQUAL "Clang")
      ...
      target_link_libraries(${TARGET} PRIVATE -fprofile-instr-generate -fcoverage-mapping)
    endif()
  endif()
endfunction()
...
function(setup_coverate_report_env TEST_NAME)
  if (ENABLE_COVERAGE_REPORT)
    if(${CMAKE_CXX_COMPILER_ID} STREQUAL "Clang")
      set_property(TEST ${TEST_NAME} PROPERTY ENVIRONMENT "LLVM_PROFILE_FILE=${CMAKE_BINARY_DIR}/coverage/${TEST_NAME}.profraw")
    endif()
  endif()
endfunction()